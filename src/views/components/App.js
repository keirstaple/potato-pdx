...
import logo from '../images/logo_wordmark.svg';
  ...
  render() {
    ...
    return (
      <div className="App" style={{ height: `${scrollHeight}px`, position: 'relative'}}>
        <img src={logo} alt="logo" style={{ position: 'fixed', height: '3.5vh', top: '10px', left: '10px', bottom: '10px', right: '10px', width: 'auto', zIndex: '5' }} />
